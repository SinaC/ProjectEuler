...
namespace Fractions
{
    ...
    public struct Fraction : IComparable, IFormattable
    {
        ...
        public Int32 ToInt32()
        {
            if (m_Denominator == 0)
            {
                throw new FractionException(string.Format("Cannot convert {0} to Int32", IndeterminateTypeName(m_Numerator)), new NotFiniteNumberException());
            }
        ...
        public Int64 ToInt64()
        {
            if (m_Denominator == 0)
            {
                throw new FractionException(string.Format("Cannot convert {0} to Int64", IndeterminateTypeName(m_Numerator)), new NotFiniteNumberException());
            }
        ...
        public static Fraction ToFraction(string inValue)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    int decimalPos = inValue.IndexOf(info.CurrencyDecimalSeparator, StringComparison.Ordinal);
